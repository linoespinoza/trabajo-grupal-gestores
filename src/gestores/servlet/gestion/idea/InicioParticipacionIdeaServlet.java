 ...
 */
@WebServlet("/InicioParticipacionIdeaServlet")
public class InicioParticipacionIdeaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InicioParticipacionIdeaServlet() {
        super();
...
*/			
		...
		response.sendRedirect(ParticipacionIdeaConstante.PAG_PARTICIPACION_IDEA);
	}
