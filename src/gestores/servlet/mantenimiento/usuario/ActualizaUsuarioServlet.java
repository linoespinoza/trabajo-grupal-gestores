 ...
 */
@WebServlet("/ActualizaUsuarioServlet")
public class ActualizaUsuarioServlet extends HttpServlet {

	private static final long serialVersionUID = -1795119275557250544L;

	public ActualizaUsuarioServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			gestionUsuario.actualizar(usuario);
			...
			RequestDispatcher requestDispatcher = request
					.getRequestDispatcher("/"
							+ UsuarioConstante.PAG_EDITA_USUARIO);
