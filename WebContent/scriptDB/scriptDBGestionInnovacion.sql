...
CREATE SCHEMA IF NOT EXISTS `gestioninnovacion1` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `gestioninnovacion1` ;

-- -----------------------------------------------------
-- Table `gestioninnovacion1`.`PLAN_TARIFARIO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestioninnovacion1`.`PLAN_TARIFARIO` ;

CREATE TABLE IF NOT EXISTS `gestioninnovacion1`.`PLAN_TARIFARIO` (
...
-- -----------------------------------------------------
-- Table `gestioninnovacion1`.`CENTRO_FORMACION`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestioninnovacion1`.`CENTRO_FORMACION` ;

CREATE TABLE IF NOT EXISTS `gestioninnovacion1`.`CENTRO_FORMACION` (
...
INS: Instituto.*/,
  ...
  CONSTRAINT `fk_CENTRO_FORMACION_PLAN_TARIFARIO1`
    ...
    REFERENCES `gestioninnovacion1`.`PLAN_TARIFARIO` (`Co_Plan_Tarifario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `gestioninnovacion1`.`USUARIO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestioninnovacion1`.`USUARIO` ;

CREATE TABLE IF NOT EXISTS `gestioninnovacion1`.`USUARIO` (
  ...
  `Co_Tipo_Documento` CHAR(3) NOT NULL COMMENT 'Código de Tipo de Documento.\nValores:\nDNI: DNI. Longitud: 8. Tipo: Numérico.\nCEX: Carnet de Extranjería. Longitud: 12. Tipo: Alfanumérico.\nRUC: RUC. Longitud: 11. Tipo: Numérico.\nPAS: Pasaporte' /* comment truncated */ /*. Longitud: 12. Tipo: Alfanumérico.
...
ADM: Administrador.*/,
  ...
  CONSTRAINT `fk_USUARIO_CENTRO_FORMACION1`
    ...
    REFERENCES `gestioninnovacion1`.`CENTRO_FORMACION` (`Co_Centro_Formacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `gestioninnovacion1`.`IDEA`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestioninnovacion1`.`IDEA` ;

CREATE TABLE IF NOT EXISTS `gestioninnovacion1`.`IDEA` (
...
Debe estar en formato fecha y hora (dd/MM/yyyy HH:mm:ss).*/,
  ...
  CONSTRAINT `fk_IDEA_USUARIO1`
    ...
    REFERENCES `gestioninnovacion1`.`USUARIO` (`Co_Usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `gestioninnovacion1`.`USUARIO_PERMITIDO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestioninnovacion1`.`USUARIO_PERMITIDO` ;

CREATE TABLE IF NOT EXISTS `gestioninnovacion1`.`USUARIO_PERMITIDO` (
  ...
  CONSTRAINT `fk_USUARIO_PERMITIDO_IDEA1`
    FOREIGN KEY (`Co_Idea`)
    REFERENCES `gestioninnovacion1`.`IDEA` (`Co_Idea`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `gestioninnovacion1`.`REUNION`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestioninnovacion1`.`REUNION` ;

CREATE TABLE IF NOT EXISTS `gestioninnovacion1`.`REUNION` (
  `Co_Reunion` INT NOT NULL AUTO_INCREMENT COMMENT 'Código de Reunión. Es correlativo.',
  `Co_Idea` INT NOT NULL COMMENT 'Código de Idea.',
  `Fe_Reunion` DATETIME NOT NULL COMMENT 'Fecha de Reunión.\nValores:' /* comment truncated */ /*Debe estar en formato fecha (dd/MM/yyyy HH:mm:ss).*/,
...
-- -----------------------------------------------------
-- Table `gestioninnovacion1`.`REPORTE_PAGO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestioninnovacion1`.`REPORTE_PAGO` ;

CREATE TABLE IF NOT EXISTS `gestioninnovacion1`.`REPORTE_PAGO` (
...
-- -----------------------------------------------------
-- Table `gestioninnovacion1`.`DISCUCION_IDEA`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestioninnovacion1`.`DISCUCION_IDEA` ;

CREATE TABLE IF NOT EXISTS `gestioninnovacion1`.`DISCUCION_IDEA` (
  ...
  CONSTRAINT `fk_DISCUCION_IDEA_USUARIO_PERMITIDO`
    ...
    REFERENCES `gestioninnovacion1`.`USUARIO_PERMITIDO` (`Co_Idea` , `Co_Usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
