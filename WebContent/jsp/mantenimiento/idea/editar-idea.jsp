...
<body>
	...
	<div class="container">
		<form id="formIdea" name="formulario" role="form" method="post" action="${contextPath}/ActualizaIdeaServlet" 
        enctype="multipart/form-data">
            <legend>Mantenimiento de Idea | Editar</legend>
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="codigo" value="${idea.codigo}" />
